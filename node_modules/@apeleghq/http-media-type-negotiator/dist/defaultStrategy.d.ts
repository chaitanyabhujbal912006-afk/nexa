 ...
 */
declare const defaultStrategy: (availableMediaTypes: readonly Readonly<TNormalisedMediaType>[], acceptableMediaTypes: readonly Readonly<TNormalisedMediaType>[], qMap: Readonly<WeakMap<Readonly<import("./parseMediaType.js").TMediaType>, number>>) => Readonly<TNormalisedMediaType> | null;
