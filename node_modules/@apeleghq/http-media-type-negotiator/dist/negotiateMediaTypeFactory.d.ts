...
interface IMediaTypeNegotiationStrategy {
    (parsedAvailableTypes: readonly Readonly<TNormalisedMediaType>[], parsedAcceptableTypes: readonly Readonly<TNormalisedMediaType>[], qMap: Readonly<WeakMap<Readonly<TMediaType>, number>>): TNormalisedMediaType | null;
}
/**
 ...
 * ); // -> 'text/plain; charset=utf-8'
 */
declare const negotiateMediaTypeFactory: (availableMediaTypes: string[], strategy?: IMediaTypeNegotiationStrategy) => (accept?: string | null | undefined, permissive?: boolean) => string | null;
export default negotiateMediaTypeFactory;
export type { IMediaTypeNegotiationStrategy };
//# sourceMappingURL=negotiateMediaTypeFactory.d.ts.map