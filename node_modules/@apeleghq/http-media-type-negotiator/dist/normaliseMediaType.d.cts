import { $orignal } from './constants.cjs';
import { type TMediaType } from './parseMediaType.cjs';
type TNormalisedMediaType = TMediaType & {
    readonly [$orignal]: TMediaType;
};
/**
 ...
 */
declare const normaliseMediaType: (mediaType: TMediaType) => TNormalisedMediaType;
export type { TMediaType, TNormalisedMediaType };
export default normaliseMediaType;
//# sourceMappingURL=normaliseMediaType.d.ts.map